...
class Manager extends Employee {
    protected teamMember: string[];
    constructor(name: string, teamMember: string[]) {
        super(name);
    ...
    getProfile(): void {
        ...
        console.log("name", this.name, "teamMember", this.teamMember);
    }
}

let employee1 = new Manager("phong", ["tu", "tuan"])
