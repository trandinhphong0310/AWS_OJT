        ...
        <div className='min-h-screen flex flex-col px-4'>
            <div className='flex justify-between leading-[40px] mb-4'>
                ...
                <div className='flex gap-4 mt-2'>
                    ...
                    <button onClick={handleLoginPage} className='bg-black text-white px-3 rounded-xl text-[16px] cursor-pointer transition-all duration-300 ease-in-out hover:bg-gray-700'>Log in</button>
                </div>
            </div>
            <div className='flex flex-1 items-center justify-center px-4 bg-[rgb(247,247,248)]'>
                <div className='w-full max-w-md text-center'>
                    ...
                    <div className='mb-8'>
                        <span className='text-[16px] text-[#655d67]'>Hello, sign up to login</span>
                    </div>
                    <div className='text-left w-1/2 mx-auto'>
                        <form onSubmit={handleLogin}>
                            <div className='flex flex-wrap mb-6'>
                                <label className='w-full text-[18px] text-[#3c323e]'>Username</label>
                                <input
                            ...
                            <span
                                ...
                                className='absolute right-2 top-[50%] -translate-y-1/2 cursor-pointer text-xl'
                            >
                ...
                transition-all duration-300 ease-in-out hover:bg-gray-800 hover:scale-[1.02]">Sign up
                                </button>
                            </div>
                        </form>
                        <button
